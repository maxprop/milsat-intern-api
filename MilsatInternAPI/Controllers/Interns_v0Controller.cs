...
namespace MilsatInternAPI.Controllers
{
    [Route("api/v2/")]
    [ApiController]
    public class Interns_v0Controller : ControllerBase
    {
        private readonly MilsatInternAPIContext _context;
        private readonly ILogger<Interns_v0Controller> _logger;

        public Interns_v0Controller(MilsatInternAPIContext context, ILogger<Interns_v0Controller> logger)
        {
            _context = context;
            _logger = logger;
        }
